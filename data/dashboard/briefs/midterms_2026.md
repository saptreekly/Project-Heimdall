...
> Tactical snapshot · 2026-09-21 16:13:18 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **4143** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 3007 / 1226 |
| Distinct themes | 198 |
| Duplicate clusters (full DB) | 210 |
| Fuzzy clusters (snapshot cohort) | 4 |
| IU astroturf overlap | 2 bots / 2260 authors |

## Ingest yield (last 14 days)

- Runs: **276**
- Net new: **441** · re-seen: **13**
- Duplicate rate: **2.9%**

## Sentiment drift

- Trend: **stable**
- Week-over-week alert: **volume_spike_low_outrage**

## Layered coordination (frames)

- **Exact duplicate campaign** · reuters reported, district judge (2272 posts · 62 authors · 59 exact · 1 fuzzy subclusters)
...
- **Exact duplicate campaign** · upheld state, map allowing, allowing effect, midterms seat, democrats lfg (14 posts · 2 authors · 1 exact · 1 fuzzy subclusters)
...
- _…200 more exact-duplicate cluster(s) in database._
...
- red wave, midwest democrat, resigns electoral, disaster looms, state setting (99 posts)
...
- seek republican, seek republican presidential, republican presidential nomination, vice president, president vance (5 posts)
...
Coordination dupes and CIB text signals scan **all 4143 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
