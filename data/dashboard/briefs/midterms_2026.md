...
> Tactical snapshot · 2026-06-03 23:21:05 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **438** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 462 / 130 |
| Distinct themes | 23 |
| Duplicate clusters (full DB) | 22 |
...
- **3 posts** · 3 author(s) — 🔥 Breaking: Trump SUPREME COURT Announcement MAJOR Win 2026 Midterms Ele... via
...
- _…15 more exact-duplicate cluster(s) in database._
...
Coordination dupes and CIB text signals scan **all 438 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
