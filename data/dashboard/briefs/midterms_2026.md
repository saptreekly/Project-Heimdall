...
> Tactical snapshot · 2026-07-07 16:17:14 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2676** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2305 / 910 |
| Distinct themes | 100 |
| Duplicate clusters (full DB) | 146 |
| Fuzzy clusters (snapshot cohort) | 12 |
| IU astroturf overlap | 2 bots / 1754 authors |
...
- **Exact duplicate campaign** · years old (51 posts · 4 authors · 17 exact · 2 fuzzy subclusters)
...
- **Exact duplicate campaign** · vote congress, stop fraud, cold excuses, games yes, pass nationwide (10 posts · 10 authors · 1 exact · 1 fuzzy subclusters)
...
- dense_cluster_22_size_3
- dense_cluster_506_size_3
- dense_cluster_1377_size_3
...
- _…136 more exact-duplicate cluster(s) in database._
...
Coordination dupes and CIB text signals scan **all 2676 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
