...
> Tactical snapshot · 2026-07-07 00:30:04 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2662** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2296 / 908 |
| Distinct themes | 131 |
| Duplicate clusters (full DB) | 142 |
| Fuzzy clusters (snapshot cohort) | 11 |
| IU astroturf overlap | 2 bots / 1746 authors |
...
- **Exact duplicate campaign** · reuters reported, super pacs (1488 posts · 104 authors · 45 exact · 3 fuzzy subclusters)
...
- dense_cluster_505_size_3
- dense_cluster_1376_size_3
...
- potus potus, women advocates, liberty conspiracy (35 posts)
...
- corrupt doj, happy talk (8 posts)
- _…90 more emerging theme(s)._

## Scope note

Coordination dupes and CIB text signals scan **all 2662 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
