...
> Tactical snapshot · 2026-07-31 12:44:50 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3644** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2816 / 1100 |
| Distinct themes | 173 |
| Duplicate clusters (full DB) | 195 |
| Fuzzy clusters (snapshot cohort) | 1 |
| IU astroturf overlap | 2 bots / 2162 authors |
...
- **Exact duplicate campaign** · reuters reported, homeland security (2030 posts · 97 authors · 56 exact · 1 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3644 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
