...
> Tactical snapshot · 2026-07-31 16:47:50 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3655** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2825 / 1108 |
| Distinct themes | 174 |
| Duplicate clusters (full DB) | 195 |
| Fuzzy clusters (snapshot cohort) | 1 |
| IU astroturf overlap | 2 bots / 2163 authors |
...
- **Exact duplicate campaign** · reuters reported, district judge (2038 posts · 95 authors · 56 exact · 1 fuzzy subclusters)
- **Exact duplicate campaign** · judgment supreme, civil discourse, forced labor, board trustees (70 posts · 6 authors · 4 exact · 0 fuzzy subclusters)
...
- _…185 more exact-duplicate cluster(s) in database._
...
- doe completely, denied asylum, claim routes, individual directly, final removal (12 posts)
- red wave, midwest democrat, resigns electoral, disaster looms, state setting (63 posts)
...
Coordination dupes and CIB text signals scan **all 3655 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
