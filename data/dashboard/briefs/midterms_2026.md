...
> Tactical snapshot · 2026-07-25 09:17:20 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3451** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2735 / 1065 |
| Distinct themes | 83 |
| Duplicate clusters (full DB) | 189 |
| Fuzzy clusters (snapshot cohort) | 6 |
| IU astroturf overlap | 2 bots / 2094 authors |
...
- **Exact duplicate campaign** · red wave, deliver mail ballots, election integrity executive, george soros, postmaster general (2842 posts · 128 authors · 152 exact · 6 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3451 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
