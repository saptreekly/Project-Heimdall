...
> Tactical snapshot · 2026-08-01 05:40:40 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3680** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2838 / 1115 |
| Distinct themes | 142 |
| Duplicate clusters (full DB) | 195 |
| Fuzzy clusters (snapshot cohort) | 2 |
| IU astroturf overlap | 2 bots / 2171 authors |
...
- **Exact duplicate campaign** · court minus, forced labor, judgment supreme, civil discourse, board trustees (69 posts · 7 authors · 4 exact · 0 fuzzy subclusters)
- **Exact duplicate campaign** · lose control, polling stations, agents posted (50 posts · 2 authors · 15 exact · 1 fuzzy subclusters)
...
- **Exact duplicate campaign** · head special (12 posts · 0 authors · 4 exact · 0 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3680 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
