...
> Tactical snapshot · 2026-07-22 00:19:11 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3346** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2696 / 1054 |
| Distinct themes | 169 |
| Duplicate clusters (full DB) | 181 |
| Fuzzy clusters (snapshot cohort) | 7 |
| IU astroturf overlap | 2 bots / 2059 authors |

## Ingest yield (last 14 days)

- Runs: **372**
- Net new: **667** · re-seen: **2894**
- Duplicate rate: **81.3%**
...
- **Exact duplicate campaign** · reuters reported, voter eligibility (1851 posts · 114 authors · 51 exact · 2 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3346 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
