...
> Tactical snapshot · 2026-07-18 07:17:00 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3169** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2604 / 1020 |
| Distinct themes | 74 |
| Duplicate clusters (full DB) | 174 |
| Fuzzy clusters (snapshot cohort) | 8 |
| IU astroturf overlap | 2 bots / 1988 authors |

## Ingest yield (last 14 days)

- Runs: **359**
- Net new: **579** · re-seen: **2825**
- Duplicate rate: **83.0%**
...
- **Exact duplicate campaign** · mail ballots, red wave, white house, save america, president donald (2624 posts · 159 authors · 137 exact · 8 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3169 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
