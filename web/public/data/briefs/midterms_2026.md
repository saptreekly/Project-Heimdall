...
> Tactical snapshot · 2026-06-26 13:22:44 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2171** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 1960 / 784 |
| Distinct themes | 100 |
| Duplicate clusters (full DB) | 118 |
| Fuzzy clusters (snapshot cohort) | 7 |
| IU astroturf overlap | 2 bots / 1464 authors |
...
- **Exact duplicate campaign** · rick scott (30 posts · 6 authors · 9 exact · 3 fuzzy subclusters)
- **Exact duplicate campaign** · task force, voter fraud, radical left, sidney powell (25 posts · 2 authors · 7 exact · 1 fuzzy subclusters)
...
- act november, november election, america act november, act november election, late implement (10 posts)
...
Coordination dupes and CIB text signals scan **all 2171 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
