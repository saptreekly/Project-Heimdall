...
> Tactical snapshot · 2026-07-29 11:43:42 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3574** |
...
- **Exact duplicate campaign** · reuters reported, district judge (1955 posts · 98 authors · 47 exact · 3 fuzzy subclusters)
...
- _…183 more exact-duplicate cluster(s) in database._
...
Coordination dupes and CIB text signals scan **all 3574 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
