...
> Tactical snapshot · 2026-07-08 05:35:31 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2695** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2321 / 915 |
| Distinct themes | 133 |
| Duplicate clusters (full DB) | 147 |
| Fuzzy clusters (snapshot cohort) | 12 |
| IU astroturf overlap | 2 bots / 1767 authors |
...
- **Exact duplicate campaign** · reuters reported (1470 posts · 97 authors · 45 exact · 4 fuzzy subclusters)
...
- potus potus, despite looming (63 posts)
...
Coordination dupes and CIB text signals scan **all 2695 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
