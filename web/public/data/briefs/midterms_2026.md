...
> Tactical snapshot · 2026-07-06 18:27:51 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2656** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2293 / 908 |
| Distinct themes | 130 |
| Duplicate clusters (full DB) | 142 |
| Fuzzy clusters (snapshot cohort) | 12 |
| IU astroturf overlap | 2 bots / 1743 authors |
...
- **Exact duplicate campaign** · reuters reported (1497 posts · 104 authors · 46 exact · 3 fuzzy subclusters)
...
- potus potus, women advocates, liberty conspiracy (34 posts)
...
Coordination dupes and CIB text signals scan **all 2656 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
