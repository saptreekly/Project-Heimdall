...
> Tactical snapshot · 2026-08-03 21:58:38 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3761** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2877 / 1129 |
| Distinct themes | 178 |
| Duplicate clusters (full DB) | 201 |
| Fuzzy clusters (snapshot cohort) | 7 |
| IU astroturf overlap | 2 bots / 2204 authors |

## Ingest yield (last 14 days)

- Runs: **413**
- Net new: **591** · re-seen: **3253**
- Duplicate rate: **84.6%**
...
- **Exact duplicate campaign** · reuters reported, district judge (2058 posts · 99 authors · 62 exact · 6 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 3761 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
