...
> Tactical snapshot · 2026-07-01 16:43:47 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **2494** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2199 / 882 |
| Distinct themes | 132 |
| Duplicate clusters (full DB) | 135 |
| Fuzzy clusters (snapshot cohort) | 13 |
| IU astroturf overlap | 2 bots / 1657 authors |
...
- **Exact duplicate campaign** · mike johnson, federal government (1373 posts · 111 authors · 42 exact · 5 fuzzy subclusters)
...
Coordination dupes and CIB text signals scan **all 2494 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
