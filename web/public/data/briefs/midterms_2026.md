...
> Tactical snapshot · 2026-06-10 18:10:50 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **1061** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 1043 / 399 |
| Distinct themes | 63 |
| Duplicate clusters (full DB) | 57 |
| Fuzzy clusters (snapshot cohort) | 8 |
| IU astroturf overlap | 1 bots / 755 authors |
...
- **Exact duplicate campaign** · similar rules (11 posts · 5 authors · 1 exact · 1 fuzzy subclusters)
...
- **5 posts** · 5 authors · ~100% Jaccard — BREAKING: Republicans are favored to NOW WIN the HOUSE in the 2026 MIDTERMS. THIS IS HUGE MAGA KEEPS ON WINNING BIG TIME TIME TO GET LOUD 🔥
...
- pass save america, mail voting, camera actual (5 posts)
...
Coordination dupes and CIB text signals scan **all 1061 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
