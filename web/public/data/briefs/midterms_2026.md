...
> Tactical snapshot · 2026-07-31 20:17:19 UTC

## Corpus

| Metric | Value |
| --- | --- |
| Posts in database | **3665** |
...
| Organic score | 0.45 |
| Graph nodes / edges | 2828 / 1108 |
| Distinct themes | 173 |
| Duplicate clusters (full DB) | 195 |
| Fuzzy clusters (snapshot cohort) | 1 |
| IU astroturf overlap | 2 bots / 2167 authors |

## Ingest yield (last 14 days)

- Runs: **410**
- Net new: **603** · re-seen: **3341**
- Duplicate rate: **84.7%**
...
- **Exact duplicate campaign** · reuters reported (2041 posts · 95 authors · 59 exact · 1 fuzzy subclusters)
...
- red wave, midwest democrat, resigns electoral, disaster looms, state setting (62 posts)
...
Coordination dupes and CIB text signals scan **all 3665 database posts**. Fuzzy clusters and sentiment charts use the **250-post snapshot cohort** (limit 250).
