...
class OutrageScore(Base):
    ...
    escalation_tier: Mapped[str] = mapped_column(String(32), default="neutral")
    negativity_score: Mapped[float] = mapped_column(Float, default=0.0)
    ragebait_score: Mapped[float] = mapped_column(Float, default=0.0)
